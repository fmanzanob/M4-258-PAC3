(function() {
   ...
   */ var reduce = function fastReduceObject(subject, fn, initialValue, thisContext) {
    ...
    function defineIcons(prefix, icons) {
        ...
        else namespace.styles[prefix] = _objectSpread({
    ...
    var mutators = {
        replace: function replace(mutation) {
            ...
            if (node.parentNode && node.outerHTML) node.outerHTML = newOuterHTML + (config.keepOriginalSource && node.tagName.toLowerCase() !== 'svg' ? "<!-- ".concat(node.outerHTML, " Font Awesome fontawesome.com -->") : '');
...
//# sourceMappingURL=articulo.aebc42cf.js.map
